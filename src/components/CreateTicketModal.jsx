                        ...
                        {step === 1 ? (
                            <div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div
                                        className={`p-4 border rounded-lg cursor-pointer ${ticketType === "PAGADO"
                                    ...
                                    >
                                        <div className="flex items-center mb-2">
                                            <div
                                                className={`w-5 h-5 rounded-full border ${ticketType === "PAGADO" ? "border-purple-500" : "border-gray-300"
                                                    } flex items-center justify-center mr-2`}
                                            >
                                                {ticketType === "PAGADO" && <div className="w-3 h-3 rounded-full bg-purple-500"></div>}
                                            </div>
                                    ...
                                    <div
                                        className={`p-4 border rounded-lg cursor-pointer ${ticketType === "GRATIS"
                                                ? "border-purple-500 bg-purple-50"
                                                : "border-gray-200 hover:border-gray-300"
                                            }`}
                                    ...
                                    >
                                        <div className="flex items-center mb-2">
                                            <div
                                                className={`w-5 h-5 rounded-full border ${ticketType === "GRATIS" ? "border-purple-500" : "border-gray-300"
                                                    } flex items-center justify-center mr-2`}
                                            >
                                                {ticketType === "GRATIS" && <div className="w-3 h-3 rounded-full bg-purple-500"></div>}
                                            </div>
                                    ...
                                    <div
                                        className={`p-4 border rounded-lg cursor-pointer ${ticketType === "DONACION"
                                                ? "border-purple-500 bg-purple-50"
                                                : "border-gray-200 hover:border-gray-300"
                                            }`}
                                    ...
                                    >
                                        <div className="flex items-center mb-2">
                                            <div
                                                className={`w-5 h-5 rounded-full border ${ticketType === "DONACION" ? "border-purple-500" : "border-gray-300"
                                                    } flex items-center justify-center mr-2`}
                                            >
                                                {ticketType === "DONACION" && <div className="w-3 h-3 rounded-full bg-purple-500"></div>}
                                            </div>
                                    ...
                                    <div
                                        className={`p-4 border rounded-lg cursor-pointer ${ticketType === "ESCALONADO"
                                                ? "border-purple-500 bg-purple-50"
                                                : "border-gray-200 hover:border-gray-300"
                                            }`}
                                    ...
                                    >
                                        <div className="flex items-center mb-2">
                                            <div
                                                className={`w-5 h-5 rounded-full border ${ticketType === "ESCALONADO" ? "border-purple-500" : "border-gray-300"
                                                    } flex items-center justify-center mr-2`}
                                            >
                                                {ticketType === "ESCALONADO" && <div className="w-3 h-3 rounded-full bg-purple-500"></div>}
                                            </div>
